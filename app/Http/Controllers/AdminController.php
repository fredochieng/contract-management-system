...
class ContractController extends Controller
{
    ...
    public function viewContract($contract_id = null)
    {
        ...
        // $latest_draft = contract::where('contract_id', function ($query) {
        //     $query->select('contract_id')->where('created_at', DB::raw("(select max('created_at') from contracts)"));
        // })->latest()->first();

        // echo "<pre>";
        // print_r($latest_draft);
        // exit;
