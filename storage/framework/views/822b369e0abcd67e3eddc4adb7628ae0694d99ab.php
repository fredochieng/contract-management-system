                                                    ...
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="text center-text" valign="middle" align="left"
                                                                ...
                                                                Hello <?php echo e($email->name); ?>,<br /><br />

                                                                Your contract request has been acknowledged.<br />
                                                                Ticket ID: <b>#<?php echo e($email->contract_code); ?></b><br /><br />

                                                                <?php echo e($email->message); ?><br /><br />

                                                                You can reply to this email to add additional
                                                                information.<br />
                                                                You can login to Wananchi Legal System to view the progress of the
                                                                contract.<br /><br />

                                                                Best regards,<br />
                                                                <?php echo e($email->company); ?>
