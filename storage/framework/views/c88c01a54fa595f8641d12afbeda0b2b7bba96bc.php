<div class="modal fade" id="modal_share_reviewed_contract" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo Form::open(['action'=>'ContractController@shareReviewedContract', $contract->contract_id,'method'=>'POST','class'=>'form','enctype'=>'multipart/form-data']); ?>

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Share Reviewed Contract (<span style="font-weight:bolder"><?php echo e($contract->contract_code); ?></span>)</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo e(Form::label('Upload Reviewed Contract Document')); ?>

                            <div class="form-group">
                                <?php echo e(Form::file('reviewed_contract_document',['class'=>'form-control', 'required'])); ?>
