<?php $__env->startSection('title', 'Wananchi Legal | Approved Contracts'); ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><span class="pull-right-container">
                                                        <small class="badge bg-green"><?php echo e($approved_contract->status_name); ?></small></span>
                                                </td>
                                        ...
                                        <table id="example2" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                            <small class="badge bg-green"><?php echo e($approved_by_me_contract->status_name); ?></small></span>
                                                    </td>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-info btn-block btn-sm btn-flat" href="/contract/<?php echo e($approved_by_me_contract->contract_id); ?>/view"><i class="fa fa-eye"></i> View</a>
                                                        </div>
                                                    </td>
                                                    <?php echo Form::close(); ?>
