<?php $__env->startSection('title', 'CMS | Approved Contracts'); ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($approved_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> Contract</a>                                                        |
                                                        <a href="/<?php echo e($approved_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> CRF</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                <li><a href="/contract/<?php echo e($approved_contract->contract_id); ?>/view"
                                        ...
                                        <table id="example2" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($approved_by_me_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> Contract</a>                                                        |
                                                        <a href="/<?php echo e($approved_by_me_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> CRF</a>
                                                    </td>
                                                    ...
                                                    <small class="label pull-center btn-warning"><?php echo e($approved_by_me_contract->contract_status); ?></small></span>                                                        <?php elseif($approved_contract->contract_status == 'published'): ?>
                                                        ...
                                                        <?php elseif($approved_contract->contract_status== 'submitted'): ?>
                                                        <small class="label label-success"><?php echo e($approved_by_me_contract->contract_status); ?></small></span>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($my_approved_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> Contract</a>                                                        |
                                                        <a href="/<?php echo e($my_approved_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> CRF</a>
                                                    </td>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                        ...
                                                        <?php elseif($my_approved_contract->contract_status== 'submitted'): ?>
                                                        <small class="label label-success"><?php echo e($my_approved_contract->contract_status); ?></small></span>
        ...
        <table id="example4" class="table no-margin">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                         <?php if(auth()->check()): ?> <?php if(auth()->user()->isUser() && ($approved_contract->contract_status
                        == 'created' || $approved_contract->contract_status == 'ammended')): ?>
                        <a href="/contract/<?php echo e($approved_contract->contract_id); ?>/edit">
                                        <span class = "fa fa-pencil bigger"></span></center></a>                        <?php else: ?>

                        <a href="/contract/<?php echo e($approved_contract->contract_id); ?>/view">
                                                                            <span class = "fa fa-eye bigger"></span></center></a>                        <?php endif; ?> <?php endif; ?> <?php echo Form::open(['action'=>['ContractController@destroy',$approved_contract->contract_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data']); ?> <?php echo e(Form::hidden('_method','DELETE')); ?> 
                        <a class="delete" data-id="<?php echo e($approved_contract->contract_id); ?>" href="javascript:void(0)">
