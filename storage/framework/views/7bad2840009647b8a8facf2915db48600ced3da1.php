         ...
         <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
               <tr>
                  ...
                  <td style="width:120px"> <a href="/<?php echo e($contract->draft_file); ?>" class="btn btn-primary" target="_blank"><i class="fa fa-fw fa-download"></i> Contract document</a></td>
                  <td style="width:120px">  <button type="button" class="btn btn-primary">
                     <i class="fa fa-download"></i> CRF Document
                     </button>
                  </td>
                  <td><center><p class="text-light-blue"><?php echo e($contract->status); ?></p></center></td>
               </tr>
            </tbody>
         </table>
      </div>
