                                        ...
                                        <table id="example1" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($approved_contract->draft_file); ?>" target="_blank"><i
                                                                class="fa fa-fw fa-download"></i> Contract</a>
                                                    </td>
                                                   <td><span class="pull-right-container">
                                                        <small class="badge bg-grey"><?php echo e($approved_contract->status_name); ?></small></span>
                                                </td>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                        ...
                                        <table id="example2" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($approved_by_me_contract->draft_file); ?>"
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-primary btn-block btn-sm btn-flat"
                                    href="/contract/<?php echo e($approved_contract->contract_id); ?>/view"><i class="fa fa-eye"></i>
                                    View</a>
                            </div>
                        </td>
                        <?php echo Form::close(); ?>
