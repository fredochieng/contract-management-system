<div class="modal fade" id="modal_upload_approved_caf">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo Form::open(['action'=>'ContractController@uploadApprovedCAF','method'=>'POST','class'=>'form','enctype'=>'multipart/form-data']); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <?php echo e(Form::label('Share Approved CAF with user *')); ?>

                            <div class="form-group">
                                <?php echo e(Form::file('approved_caf',['class'=>'form-control', 'required', 'accept'=>'.doc , .docx , .pdf'])); ?>
