<div class="modal fade" id="modal_share_final_execution" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo Form::open(['action'=>'ContractController@shareFinalExecution', $contract->contract_id,'method'=>'POST','class'=>'form','enctype'=>'multipart/form-data']); ?>

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Share Final Execution Version (<span style="font-weight:bolder"><?php echo e($contract->contract_code); ?></span>) for sign off</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo e(Form::label('Upload Final Execution Version')); ?>

                            <div class="form-group">
                                <?php echo e(Form::file('final_execution_version',['class'=>'form-control', 'required'])); ?>
