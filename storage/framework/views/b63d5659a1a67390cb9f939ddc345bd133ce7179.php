                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table no-margin">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $final_execution_sent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$reviewed_contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($key+1); ?></td>
                                                    <td><a
                                                            href="/contract/<?php echo e($reviewed_contract->contract_id); ?>/view"><?php echo e($reviewed_contract->contract_code); ?></a>
