<?php $__env->startSection('title', 'Terminated Contracts'); ?>
                                        ...
                                        <table id="example1" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($terminated_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> Contract</a>                                                        |
                                                        <a href="/<?php echo e($terminated_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> CRF</a>
                                                    </td>
                                        ...
                                        <table id="example2" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($terminated_by_me_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> Contract</a>                                                        |
                                                        <a href="/<?php echo e($terminated_by_me_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> CRF</a>
                                                    </td>
                                        ...
                                        <table id="example3" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/<?php echo e($my_terminated_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> Contract</a>                                                        |
                                                        <a href="/<?php echo e($my_terminated_contract->draft_file); ?>" target="_blank"><i class="fa fa-fw fa-download"></i> CRF</a>
                                                    </td>
            ...
            <table id="example1" class="table table-striped table-bordered records">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(auth()->check()): ?> <?php if(auth()->user()->isUser() && ($terminated_contract->contract_status == 'created' || $terminated_contract->contract_status
                            == 'ammended')): ?>
                            <a href="/contract/<?php echo e($terminated_contract->contract_id); ?>/edit">
                                <span class = "fa fa-pencil bigger"></span></center></a> <?php else: ?>

                            <a href="/contract/<?php echo e($terminated_contract->contract_id); ?>/view">
                                                                    <span class = "fa fa-eye bigger"></span></center></a>                            <?php endif; ?> <?php endif; ?> <?php echo Form::open(['action'=>['ContractController@destroy',$terminated_contract->contract_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data']); ?> <?php echo e(Form::hidden('_method','DELETE')); ?> 
                            <a class="delete" data-id="<?php echo e($terminated_contract->contract_id); ?>" href="javascript:void(0)">
