                                        ...
                                        <table id="example1" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/contract/<?php echo e($pending_contract->contract_id); ?>/view"><?php echo e($pending_contract->contract_code); ?></a></td>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                        ...
                                                        <small class="badge bg-purple"><?php echo e($pending_contract->contract_status); ?></small></span
                                                        <?php elseif($pending_contract->contract_status == 'Pending'): ?>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-info btn-block btn-sm btn-flat" href="/contract/<?php echo e($pending_contract->contract_id); ?>/view"><i class="fa fa-eye"></i> View</a>
                                                        </div>
                                                    </td>
                                                    <?php echo Form::close(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example2" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e($key+1); ?></td>
                                                    <td><a href="/contract/<?php echo e($overdue_pending_contract->contract_id); ?>/view"><?php echo e($overdue_pending_contract->contract_code); ?></a></td>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                        ...
                                                        <small class="badge bg-purple"><?php echo e($overdue_pending_contract->contract_status); ?></small></span>
                                                        <?php elseif($overdue_pending_contract->contract_status == 'Pending'): ?>
                                                        ...
                                                        <small class="badge bg-red"><?php echo e($overdue_pending_contract->contract_status); ?></small></span>
                                                    </td>
                                                    <?php endif; ?> <?php if(auth()->check()): ?> <?php if(auth()->user()->isAdmin() || auth()->user()->isLegal()): ?>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-info btn-block btn-sm btn-flat" href="/contract/<?php echo e($overdue_pending_contract->contract_id); ?>/view"><i class="fa fa-eye"></i> View</a>
                                                        </div>
                                                    </td>
                                                    <?php echo Form::close(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example2" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e($key+1); ?></td>
                                                    <td><a href="/contract/<?php echo e($overdue_pending_contract->contract_id); ?>/view"><?php echo e($overdue_pending_contract->contract_code); ?></a>
                                                        </td>
                                                    <td><a href="/contract/<?php echo e($overdue_pending_contract->contract_id); ?>/view"><?php echo e($overdue_pending_contract->contract_title); ?></a></td>
                                                    <td><a href="/contract-party/<?php echo e($overdue_pending_contract->party_id); ?>/view-contract-party"
                                                            target="_blank">
                                                    ...
                                                    <?php endif; ?> <?php if(auth()->check()): ?> <?php if(auth()->user()->isAdmin() || auth()->user()->isLegal()): ?>
                                                    <td>
                                                        <?php if($overdue_pending_contract->assigned =='' && $overdue_pending_contract->escalation_duration
                                                        <=1 ): ?> <span class="label" style="background-color:#FFF;color:#1e3fda;border:1px solid #1e3fda">Open</span> <?php endif; ?>
                                                    </td>
                                                    <?php endif; ?> <?php endif; ?>
                                                    <td>
                                                        <div class="btn-group">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example3" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e($key+1); ?></td>
                                                    <td><a href="/contract/<?php echo e($assigned_pending_contract->contract_id); ?>/view"><?php echo e($assigned_pending_contract->contract_code); ?></a>
                                                        </td>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                                        ...
                                                                        <small class="badge bg-purple"><?php echo e($assigned_pending_contract->contract_status); ?></small></span>
                                                                        <?php elseif($assigned_pending_contract->contract_status == 'Pending'): ?>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-info btn-block btn-sm btn-flat" href="/contract/<?php echo e($assigned_pending_contract->contract_id); ?>/view"><i class="fa fa-eye"></i> View</a>
                                                        </div>
                                                    </td>
                                                    <?php echo Form::close(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example4" class="table no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e($key+1); ?></td>
                                                    <td><a href="/contract/<?php echo e($my_pending_contract->contract_id); ?>/view"><?php echo e($my_pending_contract->contract_code); ?></a>
                                                        </td>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                                                            ...
                                                                                            <small class="badge bg-purple"><?php echo e($my_pending_contract->contract_status); ?></small></span>
                                                                                            <?php elseif($my_pending_contract->contract_status == 'Pending'): ?>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-info btn-block btn-sm btn-flat" href="/contract/<?php echo e($my_pending_contract->contract_id); ?>/view"><i class="fa fa-eye"></i> View</a>
                                                        </div>
                                                    </td>
                                                    <?php echo Form::close(); ?>
        ...
        <div class="table-responsive">
            <table id="example1" class="table no-margin">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($key+1); ?></td>
                        <td><a href="/contract/<?php echo e($pending_contract->contract_id); ?>/view"><?php echo e($pending_contract->contract_code); ?></a>
                            </td>
                        <td><a href="/contract/<?php echo e($pending_contract->contract_id); ?>/view"><?php echo e($pending_contract->contract_title); ?></a></td>
