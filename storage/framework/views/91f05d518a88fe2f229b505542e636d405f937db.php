            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="pull-right-container">
                        ...
                        <?php elseif($contract->contract_status== 'terminated'): ?> <?php elseif($contract->contract_status== 'closed'): ?>
                        <small class="badge bg-aqua"><?php echo e($contract->contract_status); ?></small></span>
                    </td>
                    <?php endif; ?>
                    </td>
                    <td>
                        <?php if(auth()->check()): ?> <?php if(auth()->user()->isUser() && ($contract->contract_status == 'created' || $contract->contract_status==
                        'amended')): ?>
                        <a href="/contract/<?php echo e($contract->contract_id); ?>/edit" class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit Contract">
                            <span class = "fa fa-pencil bigger"></span></a> <?php else: ?>
                        <a href="/contract/<?php echo e($contract->contract_id); ?>/view" class="btn btn-primary btn-xs" data-toggle="tooltip" title="View Contract Details">
                            <span class = "fa fa-eye bigger"></span></a> <?php endif; ?> <?php endif; ?> <?php echo e(Form::hidden('_method','POST')); ?> <?php echo Form::open(['action'=>['ContractController@destroy',$contract->contract_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data']); ?> <?php echo e(Form::hidden('_method','DELETE')); ?>
