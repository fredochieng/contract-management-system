        ...
        <table id="example1" class="table table-striped table-bordered records">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="/{{$contract->draft_file}}" target="_blank"><i class="fa fa-fw fa-download"></i>
                            Contract</a> |
                        <a href="/{{$contract->draft_file}}" target="_blank"><i class="fa fa-fw fa-download"></i>
                            CRF</a>
                    </td>
                    ...
                    <td>
                        <center><span class="pull-right-container">
                                ...
                                <small
                                    class="label pull-center btn-warning">{{$contract->contract_status}}</small></span>
                    ...
                    <small class="label pull-center btn-danger">{{$contract->contract_status}}</small></span></center>
                    </td>
                    @endif
                    </td>
                    <td>
                        ...
                        {{-- <a href="/admin/contract/{{$contract->contract_id}}/edit" id="editBtn" class="label
                        bg-primary">Edit</a> --}}
                        <a href="/admin/contract/{{$contract->contract_id}}/edit">
                            <span class="fa fa-pencil bigger"></span></center></a>
                        @else
                        {{-- <a href="/contract/{{$contract->contract_id}}/view" id="editBtn" class="label
                        bg-green">Published</a> --}}
