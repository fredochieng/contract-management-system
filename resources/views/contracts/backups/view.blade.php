    ...
    <section class="invoice">
        ...
        @if($contract->contract_status == 'created')
         ...
         @endif @endif
                   ...
                   <a href="/contract/{{$contract->contract_id}}/edit" class="btn btn-success"><i class="fa fa-check"></i> APPROVE CHANGES</a>
