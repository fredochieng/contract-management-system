...
@section('title', 'CMS | Ammended Contracts')
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                        ...
                                                        @elseif($ammended_contract->contract_status== 'ammended')
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                ...
                                                                == 'ammended'))
                                                                <li><a href="/contract/{{$ammended_contract->contract_id}}/edit"
                                                                        class="edit-contract"><i class="fa fa-pencil"></i> View</a></li>
                                                                @else
                                                                <li><a href="/contract/{{$ammended_contract->contract_id}}/view"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                        ...
                                                        @elseif($ammended_by_me_contract->contract_status== 'ammended')
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                @if (auth()->check()) @if(auth()->user()->isUser() && ($ammended_by_me_contract->contract_status == 'created' || $ammended_by_me_contract->contract_status
                                                                == 'ammended'))
                                                                <li><a href="/contract/{{$ammended_by_me_contract->contract_id}}/edit"
                                                                        class="edit-contract"><i class="fa fa-pencil"></i> View</a></li>
                                                                @else
                                                                <li><a href="/contract/{{$ammended_by_me_contract->contract_id}}/view"
                                                                        class="view-contract"><i class="fa fa-eye"></i> View</a></li>
                                                                @endif @endif
                                                                <li>
                                                                    <a href="#modal_delete_contract" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modal_delete_contract"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="pull-right-container">
                                                        ...
                                                        @elseif($my_ammended_contract->contract_status== 'ammended')
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                @if (auth()->check()) @if(auth()->user()->isUser() && ($my_ammended_contract->contract_status == 'created' || $my_ammended_contract->contract_status
                                                                == 'ammended'))
                                                                <li><a href="/contract/{{$my_ammended_contract->contract_id}}/edit"
                                                                        class="edit-contract"><i class="fa fa-pencil"></i> View</a></li>
                                                                @else
                                                                <li><a href="/contract/{{$my_ammended_contract->contract_id}}/view"
                                                                        class="view-contract"><i class="fa fa-eye"></i> View</a></li>
                                                                @endif @endif
                                                                <li>
                                                                    <a href="#modal_delete_contract" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modal_delete_contract"
