                                                ...
                                                <td>
                                                    <center>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="col-md-1"></div> --}} @endif @endif {{ Form::hidden('_method','POST') }}
                                                            ...
                                                            <a href="#modal_delete_contract" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modal_delete_contract"
                                                                class="btn btn-flat btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>                                                            {{-- <a href="" class="btn btn-flat btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete this contract?');"><i class="fa fa-trash"></i> Delete</a>                                                            --}}
                                                        </div>
                                                    </center>
                                                </td>
                                                {!! Form::close() !!}
                                    ...
                                    <table id="example2" class="table no-margin">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="label" style="background-color:#FFF;color:#0073b7;border:1px solid #0073b7;">
                                                    														<i class="fa fa-briefcase fa-fw"></i> {{$overdue_pending_contract->party_name}}													</span></td>
                                                ...
                                                <td>
                                                    <center>
                                                        <div class="btn-group">
                                                            @if (auth()->check()) @if(auth()->user()->isUser() && ($overdue_pending_contract->contract_status == 'created' || $overdue_pending_contract->contract_status=='ammended'))
                                                            <a href="/contract/{{$overdue_pending_contract->contract_id}}/edit" class="btn btn-flat btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>                                                            @else
                                                            <a href="/contract/{{$overdue_pending_contract->contract_id}}/view" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i> View</a>                                                            {{--
                                                            <div class="col-md-1"></div> --}} @endif @endif {{ Form::hidden('_method','POST') }}
                                                            {!! Form::open(['action'=>['ContractController@destroy',$overdue_pending_contract->contract_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
                                                            !!} {{Form::hidden('_method','DELETE')}}
                                                            <a href="#modal_delete_contract" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modal_delete_contract"
                                                                class="btn btn-flat btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>                                                            {{-- <a href="" class="btn btn-flat btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete this contract?');"><i class="fa fa-trash"></i> Delete</a>                                                            --}}
                                                        </div>
                                    ...
                                    <table id="example3" class="table no-margin">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="label" style="background-color:#FFF;color:#0073b7;border:1px solid #0073b7;">
                                                                    														<i class="fa fa-briefcase fa-fw"></i> {{$assigned_pending_contract->party_name}}													</span></td>
                                                ...
                                                <td>
                                                    <center>
                                                        <div class="btn-group">
                                                            @if (auth()->check()) @if(auth()->user()->isUser() && ($assigned_pending_contract->contract_status == 'created' || $assigned_pending_contract->contract_status=='ammended'))
                                                            <a href="/contract/{{$assigned_pending_contract->contract_id}}/edit" class="btn btn-flat btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>                                                            @else
                                                            <a href="/contract/{{$assigned_pending_contract->contract_id}}/view" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i> View</a>                                                            {{--
                                                            <div class="col-md-1"></div> --}} @endif @endif {{ Form::hidden('_method','POST') }}
                                                            {!! Form::open(['action'=>['ContractController@destroy',$assigned_pending_contract->contract_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
                                                            !!} {{Form::hidden('_method','DELETE')}}
                                                            <a href="#modal_delete_contract" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modal_delete_contract"
                                                                class="btn btn-flat btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>                                                            {{-- <a href="" class="btn btn-flat btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete this contract?');"><i class="fa fa-trash"></i> Delete</a>                                                            --}}
                                                        </div>
                                    ...
                                    <table id="example4" class="table no-margin">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="label" style="background-color:#FFF;color:#0073b7;border:1px solid #0073b7;">
                                                                                        														<i class="fa fa-briefcase fa-fw"></i> {{$my_pending_contract->party_name}}													</span></td>
                                                ...
                                                <td>
                                                    <center>
                                                        <div class="btn-group">
                                                            @if (auth()->check()) @if(auth()->user()->isUser() && ($my_pending_contract->contract_status == 'created' || $my_pending_contract->contract_status=='ammended'))
                                                            <a href="/contract/{{$my_pending_contract->contract_id}}/edit" class="btn btn-flat btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>                                                            @else
                                                            <a href="/contract/{{$my_pending_contract->contract_id}}/view" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i> View</a>                                                            {{--
                                                            <div class="col-md-1"></div> --}} @endif @endif {{ Form::hidden('_method','POST') }}
                                                            {!! Form::open(['action'=>['ContractController@destroy',$my_pending_contract->contract_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
                                                            !!} {{Form::hidden('_method','DELETE')}}
                                                            <a href="#modal_delete_contract" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modal_delete_contract"
                                                                class="btn btn-flat btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>                                                            {{-- <a href="" class="btn btn-flat btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete this contract?');"><i class="fa fa-trash"></i> Delete</a>                                                            --}}
                                                        </div>
