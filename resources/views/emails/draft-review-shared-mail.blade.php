                                                    ...
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            Hello {{ $email->name }},<br /><br />
                                                                ...
                                                                Contract Title: {{ $email->title }}<br/><br/>

                                                                You can login to Wananchi Legal System to view and download the draft review document.<br /><br />

                                                                Best regards,<br />
                                                                {{ $email->company }}

                                                                {{--  {{ $email->legal_name }} has uploaded a draft review for Contract:<br />
                                                                Ticket ID: <b>#{{ $email->contract_code }}</b><br /><br />
                                                                Contract Title: {{ $email->contract_title }}<br /><br />

                                                                You can login to Wananchi Legal System to view the progress of the contract.<br /><br />
