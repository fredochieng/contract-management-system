                                                    ...
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="text center-text" valign="middle" align="left"
                                                                ...
                                                                Hello {{ $email->user_name }},<br /><br />

                                                               Your contract will expire after {{ $email->duration }}(three) months.<br />
                                                                 Ticket ID: <b>#{{ $email->contract_code }}</b><br /><br />
                                                                Expiry Date: {{ $email->expiry_date }}<br/><br/>
