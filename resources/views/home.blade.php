                    ...
                    <table class="table no-margin">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if(auth()->check()) @if (auth()->user()->isAdmin() || auth()->user()->isLegal())
                                <td>
                                    @if ($contract->assigned=='' && $contract->escalation_duration >=10)
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="pull-right-container">
                                    ...
                                    <small class="badge bg-purple">{{$contract1->contract_status}}</small></span> @elseif($contract1->contract_status
                                    == 'published')
                    ...
                    <div class="box-body" style="">
                        <div class="table-responsive">
                            <table id="example4" class="table no-margin">
                                ...
                                <tbody>
                                    @foreach($standard_users as $key=>$user)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{$user->name}}</td>
                                        <td>{{$user->email}}</td>
